                            ...
                            <div class="col-md-3">
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('UsersLogout') }}">
                                ...
                                <div class="tab-content account dashboard-content pl-50">
                                    ...
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">Hello {{ $users->name }}!</h3>
                                            </div>
                                            <div class="card-body">
                                                <p>
                                    ...
                                    <div class="tab-pane fade" id="account-detail" role="tabpanel"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form id="account_form" class="form-horizontal" method="POST"
                                                    action="{{ route('front.my_account.update_profile') }}"
                                                    aria-label="{{ __('Account Form') }}" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input class="form-control" name="name" type="text"
                                                                ...
                                                                value="{{ !empty($users->name) ? $users->name : '' }}" />
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input class="form-control" name="email" type="email"
                                                                placeholder="Email"
                                                                value="{{ !empty($users->email) ? $users->email : '' }}" />
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input class="form-control" name="user_phone" type="text"
                                                                ...
                                                                value="{{ !empty($users->user_phone) ? $users->user_phone : '' }}" />
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input class="form-control" name="user_city" type="text"
                                                                placeholder="City"
                                                                value="{{ !empty($users->user_city) ? $users->user_city : '' }}" />
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label>Profile Image <span class="required">*</span>
                                                            </label>

                                                            <input type="file" class="dropify user_image"
                                                                data-default-file="{{ isset($users) && !empty($users->user_image)? asset(config('constants.USER_IMAGE_PATH') . $users->user_image): asset(config('constants.DEFAULT_USER_IMAGE_PATH')) }}"
                                                                data-height="200" name="user_image" value=""
                                                                id="user_image" />

                                                            <input type="hidden" name="default_image_icon"
                                                                id="default_image_icon" value="{{ $users->user_image }}">
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label>Phone Number <span class="required">*</span>
                                                            </label>
                                                            <textarea class="form-control" name="user_area" id="user_area"
                                                                cols="5" rows="5"
                                                                placeholder="Address">{{ !empty($users->user_area) ? $users->user_area : '' }}</textarea>
                                                        </div>
