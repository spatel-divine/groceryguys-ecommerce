            ...
            <div class="row">
              ...
              <div class="col-xl-9">
                ...
                <div id="general" class="mb-5">
                  <h4><i class="far fa-clock fa-fw"></i> {{ __('keywords.Store Time Slot')}}</h4>
                  <p>{{ __('keywords.Update Store Time Slot')}}.</p>
                ...
                <div id="sms" class="mb-5">
                  <h4><i class="far fa-bell fa-fw"></i> {{ __('keywords.Delivery Charge Setting')}}</h4>
                  <p>{{ __('keywords.Delivery Charge Setting')}}</p>
                ...
                <div class="card-body">
                     <div class="row">
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          <label>{{ __('keywords.Delivery Charge')}}</label>
                          <input type="text" name="del_charge"@if($del_charge) value="{{($del_charge->del_charge)}}" @else placeholder="{{ __('keywords.enter delivery charge')}}" @endif class="form-control">
                        </div>
                      </div>
                    </div>
              ...
              <!-- BEGIN #app_settings -->
                <div id="appsettings" class="mb-5">
                  <h4><i class="far fa-copyright fa-fw"></i> {{ __('keywords.Order Value')}}</h4>
                  <p>{{ __('keywords.Set minimum and maximum cart value')}}</p>
                  <div class="card col-md-12 col-sm-12">
