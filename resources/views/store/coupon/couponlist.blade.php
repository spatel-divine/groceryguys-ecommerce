...
<div class="card-header card-header-primary">
      <h4 class="card-title ">{{ __('keywords.Coupon')}} {{ __('keywords.List')}} {{$title}}</h4>
      <a href="{{route('coupon')}}" class="btn btn-primary ml-auto" style="width:10%;float:right;padding: 3px 0px 3px 0px;">{{ __('keywords.Add')}} {{ __('keywords.Coupon')}}</a>
    </div>
