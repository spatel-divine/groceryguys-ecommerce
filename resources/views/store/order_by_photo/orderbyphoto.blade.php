              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('process_orderby', $u->ord_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    <button type="submit" class="btn btn-secondary">{{ __('keywords.Process')}} {{ __('keywords.Order')}}</button> 
                    </form>
                 </div>
                     <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width:33.33%">{{ __('keywords.Order Qty')}}</th>
