<!DOCTYPE html>
<html class="no-js" lang="lang=" {{ str_replace('_', '-', app()->getLocale()) }}"">

<head>
    <meta charset="utf-8" />
    <title>@yield('title') | {{ config('app.name', 'The Grocery Guys') }}</title>
    ...
    <!-- Template CSS -->
    @include('front_layout.include_css')
</head>
...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="deal"
                        style="background-image: url('{{ asset('front/assets/imgs/banner/popup-1.png') }}')">
                        <div class="deal-top">
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('front/assets/imgs/shop/product-16-2.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('front/assets/imgs/shop/product-16-1.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('front/assets/imgs/shop/product-16-3.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('front/assets/imgs/shop/product-16-4.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('front/assets/imgs/shop/product-16-5.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('front/assets/imgs/shop/product-16-6.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('front/assets/imgs/shop/product-16-7.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                </div>
                                <!-- THUMBNAILS -->
                                <div class="slider-nav-thumbnails">
                                    <div><img src="{{ asset('front/assets/imgs/shop/thumbnail-3.jpg') }}"
                                            alt="product image" />
                                    </div>
                                    <div><img src="{{ asset('front/assets/imgs/shop/thumbnail-4.jpg') }}"
                                            alt="product image" />
                                    </div>
                                    <div><img src="{{ asset('front/assets/imgs/shop/thumbnail-5.jpg') }}"
                                            alt="product image" />
                                    </div>
                                    <div><img src="{{ asset('front/assets/imgs/shop/thumbnail-6.jpg') }}"
                                            alt="product image" />
                                    </div>
                                    <div><img src="{{ asset('front/assets/imgs/shop/thumbnail-7.jpg') }}"
                                            alt="product image" />
                                    </div>
                                    <div><img src="{{ asset('front/assets/imgs/shop/thumbnail-8.jpg') }}"
                                            alt="product image" />
                                    </div>
                                    <div><img src="{{ asset('front/assets/imgs/shop/thumbnail-9.jpg') }}"
                                            alt="product image" />
                                    </div>
                                </div>
                            </div>
    ...
    {{-- Main Section Content Section Start --}}
    <main class="main">
        @yield('content')
    </main>
    {{-- Main Section Content Section End --}}
    ...
    {{-- Js Section Start --}}
    @include('front_layout.include_js')
    @yield('js')
