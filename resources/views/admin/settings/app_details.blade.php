            ...
            <div class="card-body">
              ...
              <h5 class="header-title">{{ __('keywords.Choose One') }} {{ __('keywords.Payment Gateways') }}</h5>
               ...
               <form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{route('updategateway')}}" enctype="multipart/form-data">
                ...
                <br>
                <h5 class="header-title">{{ __('keywords.Paytm') }}</h5>
                <div class="params-panel border border-dark p-3">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">{{ __('keywords.Paytm Active') }}</label>           
                      <select class="form-control" name="paytm_active">
                         <option value="Yes"  {{ get_option('paytm_active') == 'Yes' ? 'selected' : '' }}>{{ __('keywords.Yes') }}</option>
                         <option value="No"  {{ get_option('paytm_active') == 'No' ? 'selected' : '' }}>{{ __('keywords.No') }}</option>
                      </select>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">{{ __('keywords.Paytm Merchant Key') }}</label>           
                      <input type="text" class="form-control" name="paytm_merchant_key" value="{{ get_option('paytm_merchant_key') }}">
                      </div>
                    </div>
                    
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">{{ __('keywords.Paytm Merchant ID') }}</label>           
                      <input type="text" class="form-control" name="paytm_merchant_id" value="{{ get_option('paytm_merchant_id') }}">
                      </div>
                    </div>
