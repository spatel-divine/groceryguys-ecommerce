...
<div class="col-lg-12">  
     <a href="{{route('can_res_add')}}" class="btn btn-primary ml-auto" style="width:12%;float:right;padding: 3px 0px 3px 0px;">{{ __('keywords.Add Reason')}}</a>
</div> 
<div class="col-lg-12">
<div class="card">    
<div class="card-header card-header-primary">
      <h4 class="card-title ">{{ __('keywords.Reason')}} {{ __('keywords.List')}}</h4>
    </div>
<div class="container">   
