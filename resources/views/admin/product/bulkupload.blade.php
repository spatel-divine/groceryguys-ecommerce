            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ol class="pl-3">
                      ...
                      <li><a href="{{ asset('public/csv_sample/products.csv') }}" download="products.csv">{{ __('keywords.Download Sample File')}}</a></li>
                   </ol>
                </div>
            </div>
        </div>  
                ...
                <div class="card-body">
                   <ol class="pl-3">
                      ...
                      <li>{{ __('keywords.fill the product id(Which is available in product list) in product_id column of csv file')}}.</li>
                       <li>{{ __('keywords.Insert tags in tags column separated by comma')}}.</li>
                      <li><a href="{{ asset('public/csv_sample/productsvarient.csv') }}"  download="products_varient.csv">{{ __('keywords.Download Sample File')}}</a></li>
                   </ol>
                </div>
            </div>
        </div>  
