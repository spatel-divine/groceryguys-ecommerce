            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ol class="pl-3">
                      ...
                      <li><a href="{{ asset('public/csv_sample/cities.csv') }}" download="products.csv">{{ __('keywords.Download Sample File')}}</a></li>
                   </ol>
                </div>
            </div>
        </div>  
            ...
            <div class="card">
                ...
                <div class="card-body">
                   <ol class="pl-3">
                      ...
                      <li><a href="{{ asset('public/csv_sample/society.csv') }}"  download="products_varient.csv">{{ __('keywords.Download Sample File')}}</a></li>
                   </ol>
                </div>
            </div>
        </div>  
