...
<div class="card-header card-header-primary">
      <h4 class="card-title ">{{ __('keywords.City')}} {{ __('keywords.List')}}</h4>
       <a href="{{route('city')}}" class="btn btn-primary ml-auto" style="width:10%;float:right;padding: 3px 0px 3px 0px;">{{ __('keywords.Add')}}</a>
    </div>
