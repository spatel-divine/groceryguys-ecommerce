...
<div class="card-header card-header-primary">
      <h4 class="card-title ">{{ __('keywords.Reward')}} {{ __('keywords.List')}}</h4>
        <a href="{{route('reward')}}" class="btn btn-primary ml-auto" style="width:12%;float:right;padding: 3px 0px 3px 0px;"><i class="material-icons">add</i>{{ __('keywords.Add')}} {{ __('keywords.Reward')}}</a>
    </div>
<div class="container">   
<table class="table">
