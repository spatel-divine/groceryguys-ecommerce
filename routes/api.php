...
Route::namespace("Api")->prefix('')->group(function () {
    ...
    Route::post('payment_load', [AppController::class,'payment']); 
     ////pages//
    ...
    Route::post('storecoupons', [AppController::class,'couponlist']);
     ...
     Route::post('checksum', [PaytmController::class,'checksum']);
     Route::post('validatesig', [PaytmController::class,'validatesig']);
    ...
    //coupon//
     ...
     Route::post('noti_product', [CategoryController::class,'noti_product']);
     Route::post('show_address', [AddressController::class,'show_address']);
 Route::post('checkout1', [OrderController::class,'checkout']);
